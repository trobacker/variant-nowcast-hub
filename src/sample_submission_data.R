...
sim_model_output <- function(locations = c("AL", "AZ", "CA", "CO", "DE"), 
  ...
  ## Works for 2024-10-02 only right now
  #' @locations Vector of location abbreviations e.g. c("MA", ...)
  #' @test_clades Clades for the week's forecasts
  #' @target_date Forecast/Nowcast dates
...
hubValidations::validate_model_data("/Users/trobacker/Projects/variant-nowcast-hub", 
